export default function Modal({ open, title, onClose, children, width = 'max-w-lg' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className={`relative bg-white/95 backdrop-blur-md rounded-[15px] w-full ${width} border border-sand-300 shadow-xl max-h-[88vh] overflow-hidden`}>
        ...
        <div className="p-5 max-h-[calc(88vh-72px)] overflow-y-auto">{children}</div>
      </div>
    </div>
  )
}
